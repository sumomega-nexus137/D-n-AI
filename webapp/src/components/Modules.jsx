    ...
    <section id="modules" className="relative mx-auto max-w-6xl px-5 py-24 sm:px-6 sm:py-32">
      <Reveal>
        ...
        <h2 className="mt-5 max-w-2xl text-4xl font-bold text-white sm:text-5xl">
          Одно фото — конкретное решение
        </h2>
        <p className="mt-4 max-w-xl text-lg text-slate-400">
          Не «вероятность 0.87», а класс, цена и что сделать с партией.
        </p>
      </Reveal>
      ...
      <div className="mt-12 grid gap-5 md:grid-cols-2">
        <Reveal delay={0.05}>
          <ModuleCard
            ...
            desc="Проба пшеницы, разложенная тонким слоем, — за секунды разбор по категориям и деньги."
            points={[
              "Доли: целое, битое, щуплое, проросшее, примесь",
